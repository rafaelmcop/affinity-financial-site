/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0dc80d5e47be09fb5401f71fd2af4a50)
// Runtime types generated with workerd@1.20260804.1 2026-08-06 nodejs_compat
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/cloudflare-staging");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JWT_SECRET" | "ADMIN_EMAIL" | "ADMIN_PASSWORD" | "PREVIEW_ADMIN_EMAIL" | "PREVIEW_ADMIN_PASSWORD" | "VITE_FRONTEND_URL">> {}
}
