(() => {
  ...
  agentNav.innerHTML = `<a href="/agentes/dashboard">Início</a><details><summary>CRM</summary><div class="sub"><a href="/agentes/crm?setor=leads">Leads</a><a href="/agentes/crm?setor=followup">Follow-up</a><a href="/agentes/crm?setor=new_business">New Business</a><a href="/agentes/crm?setor=clients">INFORCE</a><a href="/agentes/mensagens">Mensagens e automações</a></div></details><details open><summary class="active">Aplicações</summary><div class="sub"><a class="active" href="/agent-applications">Novas aplicações</a><a href="/agentes/clientes">INFORCE</a></div></details><a href="/agentes/email">E-mail <span id="application-email-badge" class="menu-badge" hidden></span></a><a href="/agentes/apolices">Apólices</a><a href="/agentes/tarefas">Tarefas</a><a href="/agentes/avaliacoes">Avaliações</a><a href="/agent-review-invites.html">Solicitar avaliação</a><a href="/agentes/configuracoes">Configurações</a><div class="nav-divider"></div><a href="/">Site principal</a><a href="#" class="logout-link" data-agent-logout>Sair</a>`;
